...
def convt(filters, kernel_size, strides, use_bias=False, padding="SAME"):
    return keras.layers.Conv2DTranspose(filters=filters, kernel_size=kernel_size, strides=strides, padding=padding,
...
class StyleGAN(RaGAN):
    def build(self, input_shape):
        ...
        o = keras.layers.Dense(self.latent_dim)(o)
        o = act_layer(o)
        o = keras.layers.Dropout(0.6)(o)
        o = keras.layers.Dense(self.latent_dim)(o)
